...
class BertModelSynCtrl(BertPreTrainedModel):
    """
    ...
    def forward(
        ...
        extended_attention_mask: torch.Tensor = self.get_extended_attention_mask_syn_ctrl(attention_mask, input_shape, device)
...
class BertForPreTraining(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = BertModelSynCtrl(config)
...
class BertLMHeadModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.bert = BertModelSynCtrl(config, add_pooling_layer=False)
